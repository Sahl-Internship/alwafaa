...
return [
    ...
    'Starts At'=>'يبدأ في',
    'Ends In'=>'ينتهي في',
    'Sub Title'=>'عنوان الدورة الفرعي',
    'Requirement'=>'المتطلبات',
    'Target Student'=>'الطالب المستهدف',
    'Targeted Skills'=>'المهارات المتوقعة في نهاية الدورة',
    ...
    'Tags'=>'الأوسمة',
    'Slug'=>'الرابط',
    "Join Requests"=>"طلبات الإلتحاق",
    "Requested Course"=>"الدورة المراد الالتحاق بها",
    ...
    "Accept"=>"قبول",
    "Refuse"=>"رفض",
    "Requested Accepted Successfully"=>"تم قبول الطلب بنجاح",
    "There is an error !! Plz try again"=>"هناك خطأ !! حاول مجددا",
    "Student Requests"=>"طلبات الإلتحاق",
    "Requested Refused Successfully"=>"تم رفض الطلب بنجاح",
    "All"=>"الجميع",
    "Here"=>"من هنا",
    "There are no Attachments"=>"لا توجد مرفقات",
    "Homework uploaded"=>"أرسل الواجبات",
    "Did not send"=>"لم يرسل",
    "Sent At"=>"أرسل في ",
    "There are no Homeworks"=>"لا توجد واجبات مرسلة",
    ""=>"",
    ""=>"",
    ""=>"",
    ""=>"",
