<template>
  <div class="row col-11" v-if="isAuthed">
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 row course-classes__timeline bg-grey-1 q-px-lg q-py-lg">
      <div class="col-6 row q-mb-md">
        ...
        <div class="text-h6 col-6 text-grey-4">
          <span class="material-icons" style="font-size:25px;cursor: pointer;">keyboard_arrow_right</span>
          8 يناير 2021
          <span class="material-icons" style="font-size:25px;cursor: pointer;">keyboard_arrow_left</span>
        </div>
      </div>
      <div class="col-6">
