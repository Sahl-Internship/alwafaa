export default {
  signup: {
    ...
    firstFormTitle: 'معلومات عامة',
    secondFormTitle: 'اﻷمان',
    thirdFormTitle: 'التحقق',
    continue: 'التالي',
    finish: 'تقدم',
    checkEmail: 'افحص بريدك اﻹلكتروني',
    emailSent: 'ارسلنا لك كود التحقق علي بريدك اﻹلكتروني',
  ...
  authNotification: {
    ...
    notvalid: ' غير صحيح',
    verfiySuccess: 'تم تاكيد بريدك بريدك اﻹلكتروني, يمكنك تسجيل الدخول',
    ...
    resetError: 'خطأ خلال تغيير كلمة المرور, حاول مرة اخري',
    DefaultError: 'خطأ, حاول مرة اخري'
  },
