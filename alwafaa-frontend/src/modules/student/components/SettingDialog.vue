      ...
      <div class="col-xs-12 col-sm-8 col-md-4">
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="public">
            ...
            >
              <g-input
                ...
                bg-color='grey-1'
                class="col-xs-6 col-sm-6 col-md-6 q-pr-xs q-pb-sm"
              />
              ...
              <g-input
                ...
                bg-color='grey-1'
                prependIconName="mdi-account"
                class="col-xs-6 col-sm-6 col-md-6 q-pb-sm"
              />
          ...
          <q-tab-panel name="privacy">
            <q-form
              class="row justify-center"
              @submit.prevent="submitSecForm"
            >
              <div class="col-12 row phone">
                <ValidationProvider
                  name="phone"
                  class="col-xs-9 col-sm-9 col-md-9 phone-input"
                ...
                <ValidationProvider
                  name="phone-key"
                  class="col-xs-3 col-sm-3 col-md-3 phone-select"
                  rules="required"
                >
                  <g-select
                    dense
                    borderless
                    v-model="user.phoneKey"
                    bg-color='grey-1'
...
export default {
  ...
  methods: {
    ...
    removeHobby (name) {
      this.hobbies = this.hobbies.filter(hobby => hobby !== name)
    },
    addHobby (e) {
  ...
  mounted () {
    const student = this.$store.state.auth.user
    const name = student.full_name.split(' ')
    this.user = {
      firstname: name[0],
      lastname: name[1],
      birthdate: '',
