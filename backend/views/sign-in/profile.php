...
<div class="user-profile-form card">
  <div class="card-body">
    ...
    <div class='row'>
      ...
      <div class="col-sm-8 col-xs-12 row align-items-start user-avatar">
        <label class="col-12">Avatar</label>
        <div class="col-12" style="margin-top: -10px;">
          <input id="image" type="file" accept="image/*">
          <!--        <img src="" alt="">-->
          <img id="img" src="<?php echo (isset($model->avatar)) ? $model->avatar : '' ?>" height="100"
            alt="Image preview..." style="<?php echo (isset($model->avatar)) ? '' : 'display: none' ?>">
        </div>
      </div>
    </div>
